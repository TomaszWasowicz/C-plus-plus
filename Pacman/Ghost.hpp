...
class Ghost
{
	...
	//To make the ghost move more slowly, i'll move it after a certain number of frames. So we need a timer.
...
public:
	...
	bool pacman_collision(const Position& i_pacman_position) const;
